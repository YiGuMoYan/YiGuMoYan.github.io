parcelRequire = function (e, r, t, n) {
    ...
    "XR92": [function (require, module, exports) {
        ...
        function e() {
            ...
            var e = ["机械的心率带动血肉的共鸣", "打开窗放逐泪光<br>微笑迎接每个曙光", "努力品尝过每段<br>曲折的时光<br>才能收获无数段<br>飞翔的希望", "至少此刻我们的心意相连<br>愿那片纯蓝天空一般高远", "将故事传颂吧<br>风携它远追<br>向宿命改写时<br>字句皆成碑", "听共鸣回响吧<br>呐喊正纷飞<br>跌落重来便是<br>启程就无悔", "旅途未完<br>千山万水空白待绘<br>枯荣相随", "坠入深空<br>追逐自由<br>放肆拥抱<br>心中的焰火", "即使不被认同<br>也能治愈所有<br>我偏执的梦", "不论这世界多糟糕<br>未来的你会光芒万丈<br>而我也曾是你万分之一的光<br>那么闪耀", "普通的disco我们普通的摇", "让我们一起 相互伴随着生命<br>用一生证明 一个 永恒的美丽"],
            i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
